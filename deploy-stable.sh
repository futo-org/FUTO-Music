...
./gradlew --stacktrace --info assembleStableRelease

VERSION="$(git describe --tags)"

ls "./app/build/outputs/apk/stable/release/"

echo "Deploying music artifacts to Cloudflare R2..."
upload_apk_latest_and_versioned "./app/build/outputs/apk/stable/release/app-stable-release.apk" "app-release.apk"
