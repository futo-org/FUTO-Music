package com.futo.music.ui.views.progress
...
class ProgressBar : View {
    ...
    constructor(context: Context, attrs: AttributeSet? = null) : super(context, attrs) {
        ...
        try {
            ...
            _paintInactive.color = a.getColor(R.styleable.ProgressBar_inactiveColor, ContextCompat.getColor(context, R.color.gray));
        } finally {
            a.recycle();
        }
    }
