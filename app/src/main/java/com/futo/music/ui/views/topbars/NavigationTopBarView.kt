...
class NavigationTopBarView: ConstraintLayout {
    ...
    constructor(context: Context, attrs: AttributeSet? = null): super(context, attrs) {
        inflate(context, R.layout.fragment_navigation_top_bar, this);
        ...
        _buttonBack.setOnClickListener {
            ...
            if(frag != null)
                ...
                StateApp.instance.activity()?.closeSegment();
        }
        ...
        if(attrs != null) {
            ...
            val attrArr = context.obtainStyledAttributes(attrs, R.styleable.NavigationTopBarView, 0, 0);
            val title = attrArr.getString(R.styleable.NavigationTopBarView_NavigationTopBar_text);
